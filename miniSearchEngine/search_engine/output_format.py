...
class winColor:
    ...
    def print_yellow_text(self, print_text, end='\n'):
        self.set_cmd_color(FOREGROUND_YELLOW)
        print(print_text, end=end)
        self.reset_color()

    def print_skyblue_text(self, print_text, end='\n'):
        self.set_cmd_color(FOREGROUND_SKYBLUE)
        print(print_text, end=end)
        self.reset_color()


def success_info(message, end='\n'):
    winColor().print_green_text(message, end)


def error_info(message, end='\n'):
    winColor().print_red_text(message, end)


def warning_info(message, end='\n'):
    winColor().print_yellow_text(message, end)


def plain_info(message, end='\n'):
    print(message, end=end)


def highlight_info(message, end='\n'):
    winColor().print_skyblue_text(message, end)
